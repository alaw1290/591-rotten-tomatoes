...
def run_test_data_weighted_avg(cosine=True):
        ...
        if(len(relevant_indeces) > 1): 
            ...
            for i in relevant_indeces:
                ...
                if(cosine):
                    ...
                    critic_similarity   = similarity_functions.run_pearson(masked_vector, matrix, movie_critic, movie_keys, critic_keys)
            ...
            toReturn[audience_names[aud_review_index].split("'s")[0]] = 'Error'
